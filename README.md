...
1. **首页** ([index.html](user/html/index.html))
   - 公司介绍和展示
   - 材料分类导航
   - 精选材料展示
   - 快速入口

2. **材料库** ([material-hub.html](user/html/material-hub.html))
   - 浏览所有材料
...
3. **材料详情** ([material-detail.html](user/html/material-detail.html))
   - 查看材料详细信息
   - 查看材料图片
   - 查看价格、规格、库存等信息
   - 查看相关材料推荐
...
4. **关于我们** ([about-us.html](user/html/about-us.html))
   - 公司简介
   - 核心价值观
   - 发展历程
   - 核心团队介绍
...
1. **材料管理** ([material-management.html](admin/html/material-management.html))
   - 查看所有材料列表
   - 搜索材料
   - 按类别筛选
   - 查看材料详情
...
2. **添加材料** ([add-material.html](admin/html/add-material.html))
   - 填写材料基本信息
   - 设置材料类别和品牌
   - 设置价格和库存
   - 上传材料图片
